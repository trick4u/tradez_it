  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Obx(() {
          ...
          final double wlRecoveryPct = wlDenominator > 0 ? (avgWin / wlDenominator) : 0.0;
          ...
          Widget semicircleGauge(double percentage, int positive, int negative) {
            return Container(
              ...
              child: Stack( // Changed from Column to Stack for better positioning
                  ...
                  children: [
                    Expanded(
                      child: _infoCard(
                        ...
                        color: Colors.white,
                        infoIcon: true,
                        additional: semicircleGauge(tradeWinPct, winningTrades, losingTrades),
                      ),
                    ),
                    SizedBox(width: 16),
                    Expanded(
                      child: _infoCard(
                        ...
                        color: Colors.white,
                        infoIcon: true,
                        additional: semicircleGauge(dayWinPct, winningDays, losingDays),
                      ),
                    ),
                  ],
                ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      wlTrade.isFinite && wlTrade >= 0 ? wlTrade.toStringAsFixed(2) : "0.00",
                      style: TextStyle(
                        color: Colors.green,
                        fontWeight: FontWeight.bold,
                        fontSize: 28,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded( // Wrapped title in Expanded to prevent overflow
                child: Text(
                  title,
